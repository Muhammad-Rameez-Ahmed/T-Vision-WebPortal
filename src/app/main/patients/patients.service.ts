...
export class PatientsService extends CommonPatientsService {
    ...
    // }
    setInactivePatients(payload: any): Observable<any> {
        return this.http.post<any>(environment.apiUrl + '/patient/PatientStatus', payload)
    }
    // }
